package com.lge.hardware.health.V1_0;
...
public interface ILGEHealth extends IBase {
    public static final String kInterfaceName = "com.lge.hardware.health@1.0::ILGEHealth";

    public static final class Proxy implements ILGEHealth {
        ...
        public String toString() {
            try {
                ...
                return "[class or subclass of com.lge.hardware.health@1.0::ILGEHealth]@Proxy";
            }
        }
        ...
        public int getChargeFull() throws RemoteException {
            ...
            _hidl_request.writeInterfaceToken(ILGEHealth.kInterfaceName);
	...
	public void debug(NativeHandle handle, ArrayList<String> msgs) {
	    return;
	}
    }

    public static abstract class Stub extends HwBinder implements ILGEHealth {
        public IHwBinder asBinder() {
            return this;
        }

        public final ArrayList<String> interfaceChain() {
            return new ArrayList(Arrays.asList(new String[]{ILGEHealth.kInterfaceName, IBase.kInterfaceName}));
        }

        public final String interfaceDescriptor() {
            return ILGEHealth.kInterfaceName;
        }
        ...
        public IHwInterface queryLocalInterface(String descriptor) {
            if (ILGEHealth.kInterfaceName.equals(descriptor)) {
                return this;
            }
            return null;
        }
        ...
        public void onTransact(int _hidl_code, HwParcel _hidl_request, HwParcel _hidl_reply, int _hidl_flags) throws RemoteException {
            ...
            switch (_hidl_code) {
                case 1:
                    ...
                    _hidl_request.enforceInterface(ILGEHealth.kInterfaceName);
    ...
    static ILGEHealth asInterface(IHwBinder binder) {
        if (binder == null) {
            return null;
        }
        IHwInterface iface = binder.queryLocalInterface(kInterfaceName);
        if (iface != null && (iface instanceof ILGEHealth)) {
            return (ILGEHealth) iface;
        }
        ILGEHealth proxy = new Proxy(binder);
        try {
    ...
    static ILGEHealth castFrom(IHwInterface iface) {
        return iface == null ? null : asInterface(iface.asBinder());
    }

    static ILGEHealth getService(String serviceName, boolean retry) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName, retry));
    }

    static ILGEHealth getService(boolean retry) throws RemoteException {
        return getService("default", retry);
    }

    static ILGEHealth getService(String serviceName) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName));
    }

    static ILGEHealth getService() throws RemoteException {
